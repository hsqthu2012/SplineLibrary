...
#if (defined(__NetBSD__) || defined(__EMSCRIPTEN__) || (defined(__hppa) && !defined(__OpenBSD__)) || (defined(__NO_LONG_DOUBLE_MATH) && (DBL_MANT_DIG != LDBL_MANT_DIG))) && !defined(BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS)
...
#if defined(__CYGWIN__) || defined(__HP_aCC) || defined(__INTEL_COMPILER) || defined(BOOST_NO_NATIVE_LONG_DOUBLE_FP_CLASSIFY) || (defined(__GNUC__) && !defined(BOOST_MATH_USE_C99)) || defined(BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS)
...
//
#if defined(BOOST_MATH_STANDALONE) && defined(_GLIBCXX_USE_FLOAT128) && defined(__GNUC__) && defined(__GNUC_MINOR__) && defined(__GNUC_PATCHLEVEL__) && !defined(__STRICT_ANSI__) && !defined(BOOST_MATH_DISABLE_FLOAT128) && !defined(BOOST_MATH_USE_FLOAT128)
