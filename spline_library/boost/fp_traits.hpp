...
static_assert((BOOST_MATH_ENDIAN_BIG_BYTE || BOOST_MATH_ENDIAN_LITTLE_BYTE) && !(BOOST_MATH_ENDIAN_BIG_BYTE && BOOST_MATH_ENDIAN_LITTLE_BYTE),
        ...
        namespace detail
        {
            ...
            */
...
#if defined(BOOST_NO_INT64_T) || defined(BOOST_NO_INCLASS_MEMBER_INITIALIZATION) || defined(BOOST_BORLANDC) || defined(__CODEGEAR__)
            ...
            struct fp_traits_non_native<double, double_precision>
            {
                ...
                static constexpr uint64_t significand = (static_cast<uint64_t>(0x000fffff) << 32) + static_cast<uint64_t>(0xffffffffu);
            ...
            struct fp_traits_non_native<long double, double_precision>
            {
                ...
                static const uint64_t significand = (static_cast<uint64_t>(0x000fffff) << 32) + static_cast<uint64_t>(0xffffffffu);
...
#if (defined(BOOST_MATH_USE_C99) && !(defined(__GNUC__) && (__GNUC__ < 4))) && !defined(__hpux) && !defined(__DECCXX) && !defined(__osf__) && !defined(__SGI_STL_PORT) && !defined(_STLPORT_VERSION) && !defined(__FAST_MATH__) && !defined(BOOST_MATH_DISABLE_STD_FPCLASSIFY) && !defined(__INTEL_COMPILER) && !defined(sun) && !defined(__VXWORKS__)
