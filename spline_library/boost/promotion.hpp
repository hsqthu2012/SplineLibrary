...
namespace boost
{
   namespace math
   {
      namespace tools
      {
         ...
         template <>
         struct promote_arg<std::float16_t>
         {
         ...
         template <>
         struct promote_arg<std::float32_t>
         {
         ...
         template <>
         struct promote_arg<std::float64_t>
         {
         ...
         template <>
         struct promote_arg<std::float128_t>
         {
...
#ifdef __STDCPP_FLOAT128_T__
         template <>
         struct promote_args_2<int, std::float128_t>
         {
            using type = std::float128_t;
         };
         template <>
         struct promote_args_2<std::float128_t, int>
         {
            using type = std::float128_t;
         };
         template <>
         struct promote_args_2<std::float128_t, float>
         {
            using type = std::float128_t;
         };
         template <>
         struct promote_args_2<float, std::float128_t>
         {
            using type = std::float128_t;
         };
         template <>
         struct promote_args_2<std::float128_t, double>
         {
            using type = std::float128_t;
         };
         template <>
         struct promote_args_2<double, std::float128_t>
         {
            using type = std::float128_t;
         };
         template <>
         struct promote_args_2<std::float128_t, long double>
         {
            using type = std::float128_t;
         };
         template <>
         struct promote_args_2<long double, std::float128_t>
         {
            using type = std::float128_t;
         };
...
#ifdef __STDCPP_FLOAT16_T__
         template <>
         struct promote_args_2<std::float128_t, std::float16_t>
         {
            using type = std::float128_t;
         };
         template <>
         struct promote_args_2<std::float16_t, std::float128_t>
         {
            using type = std::float128_t;
         };
#endif
...
#ifdef __STDCPP_FLOAT32_T__
         template <>
         struct promote_args_2<std::float128_t, std::float32_t>
         {
            using type = std::float128_t;
         };
         template <>
         struct promote_args_2<std::float32_t, std::float128_t>
         {
            using type = std::float128_t;
         };
#endif
...
#ifdef __STDCPP_FLOAT64_T__
         template <>
         struct promote_args_2<std::float128_t, std::float64_t>
         {
            using type = std::float128_t;
         };
         template <>
         struct promote_args_2<std::float64_t, std::float128_t>
         {
            using type = std::float128_t;
         };
#endif
         ...
         template <>
         struct promote_args_2<std::float128_t, std::float128_t>
         {
            using type = std::float128_t;
         };
#endif
...
#ifdef __STDCPP_FLOAT64_T__
         template <>
         struct promote_args_2<int, std::float64_t>
         {
            using type = std::float64_t;
         };
         template <>
         struct promote_args_2<std::float64_t, int>
         {
            using type = std::float64_t;
         };
         template <>
         struct promote_args_2<std::float64_t, float>
         {
            using type = std::float64_t;
         };
         template <>
         struct promote_args_2<float, std::float64_t>
         {
            using type = std::float64_t;
         };
         template <>
         struct promote_args_2<std::float64_t, double>
         {
            using type = std::float64_t;
         };
         template <>
         struct promote_args_2<double, std::float64_t>
         {
            using type = std::float64_t;
         };
         template <>
         struct promote_args_2<std::float64_t, long double>
         {
            using type = long double;
         };
         template <>
         struct promote_args_2<long double, std::float64_t>
         {
            using type = long double;
         };
...
#ifdef __STDCPP_FLOAT16_T__
         template <>
         struct promote_args_2<std::float64_t, std::float16_t>
         {
            using type = std::float64_t;
         };
         template <>
         struct promote_args_2<std::float16_t, std::float64_t>
         {
            using type = std::float64_t;
         };
#endif
...
#ifdef __STDCPP_FLOAT32_T__
         template <>
         struct promote_args_2<std::float64_t, std::float32_t>
         {
            using type = std::float64_t;
         };
         template <>
         struct promote_args_2<std::float32_t, std::float64_t>
         {
            using type = std::float64_t;
         };
#endif
         ...
         template <>
         struct promote_args_2<std::float64_t, std::float64_t>
         {
            using type = std::float64_t;
         };
#endif
...
#ifdef __STDCPP_FLOAT32_T__
         template <>
         struct promote_args_2<int, std::float32_t>
         {
            using type = std::float32_t;
         };
         template <>
         struct promote_args_2<std::float32_t, int>
         {
            using type = std::float32_t;
         };
         template <>
         struct promote_args_2<std::float32_t, float>
         {
            using type = std::float32_t;
         };
         template <>
         struct promote_args_2<float, std::float32_t>
         {
            using type = std::float32_t;
         };
         template <>
         struct promote_args_2<std::float32_t, double>
         {
            using type = double;
         };
         template <>
         struct promote_args_2<double, std::float32_t>
         {
            using type = double;
         };
         template <>
         struct promote_args_2<std::float32_t, long double>
         {
            using type = long double;
         };
         template <>
         struct promote_args_2<long double, std::float32_t>
         {
            using type = long double;
         };
...
#ifdef __STDCPP_FLOAT16_T__
         template <>
         struct promote_args_2<std::float32_t, std::float16_t>
         {
            using type = std::float32_t;
         };
         template <>
         struct promote_args_2<std::float16_t, std::float32_t>
         {
            using type = std::float32_t;
         };
#endif
         ...
         template <>
         struct promote_args_2<std::float32_t, std::float32_t>
         {
            using type = std::float32_t;
         };
#endif
...
#ifdef __STDCPP_FLOAT16_T__
         template <>
         struct promote_args_2<int, std::float16_t>
         {
            using type = std::float16_t;
         };
         template <>
         struct promote_args_2<std::float16_t, int>
         {
            using type = std::float16_t;
         };
         template <>
         struct promote_args_2<std::float16_t, float>
         {
            using type = float;
         };
         template <>
         struct promote_args_2<float, std::float16_t>
         {
            using type = float;
         };
         template <>
         struct promote_args_2<std::float16_t, double>
         {
            using type = double;
         };
         template <>
         struct promote_args_2<double, std::float16_t>
         {
            using type = double;
         };
         template <>
         struct promote_args_2<std::float16_t, long double>
         {
            using type = long double;
         };
         template <>
         struct promote_args_2<long double, std::float16_t>
         {
            using type = long double;
         };

         template <>
         struct promote_args_2<std::float16_t, std::float16_t>
         {
            using type = std::float16_t;
         };
#endif
                ...
                typename promote_args_2<
                    ...
                    typename promote_args_2<
                        ...
                        typename promote_args_2<
                            ...
                            typename promote_args_2<
                                typename std::remove_cv<T5>::type, typename std::remove_cv<T6>::type>::type>::type>::type>::type>::type;
