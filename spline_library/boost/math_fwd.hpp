   ...
   { // Math functions (in roughly alphabetic order).
      ...
      struct laguerre_result
      {
         using type = typename std::conditional<
             ...
             typename tools::promote_args<T2>::type>::type;
      };
      ...
      namespace detail
      {
         ...
         struct ellint_3_result
         {
            using type = typename std::conditional<
                ...
                tools::promote_args_t<T, U, V>>::type;
         };
      ...
      namespace detail
      {
         ...
         struct bessel_traits
         {
            using result_type = typename std::conditional<
                ...
                tools::promote_args_t<T1, T2>>::type;
      ...
      // Hypergeometrics:
      template <class T1, class T2>
      tools::promote_args_t<T1, T2> hypergeometric_1F0(T1 a, T2 z);
      template <class T1, class T2, class Policy>
      tools::promote_args_t<T1, T2> hypergeometric_1F0(T1 a, T2 z, const Policy &);

      template <class T1, class T2>
      tools::promote_args_t<T1, T2> hypergeometric_0F1(T1 b, T2 z);
      template <class T1, class T2, class Policy>
      tools::promote_args_t<T1, T2> hypergeometric_0F1(T1 b, T2 z, const Policy &);

      template <class T1, class T2, class T3>
      tools::promote_args_t<T1, T2, T3> hypergeometric_2F0(T1 a1, T2 a2, T3 z);
      template <class T1, class T2, class T3, class Policy>
      tools::promote_args_t<T1, T2, T3> hypergeometric_2F0(T1 a1, T2 a2, T3 z, const Policy &);

      template <class T1, class T2, class T3>
      tools::promote_args_t<T1, T2, T3> hypergeometric_1F1(T1 a, T2 b, T3 z);
      template <class T1, class T2, class T3, class Policy>
      tools::promote_args_t<T1, T2, T3> hypergeometric_1F1(T1 a, T2 b, T3 z, const Policy &);
...
#define BOOST_MATH_DECLARE_SPECIAL_FUNCTIONS(Policy)                                                                                                    \
   ...
   ibeta_derivative(RT1 a, RT2 b, RT3 x) { return ::boost::math::ibeta_derivative(a, b, x, Policy()); }                                                 \
                                                                                                                                                        \
   template <class T>                                                                                                                                   \
   T binomial_coefficient(unsigned n, unsigned k) { return ::boost::math::binomial_coefficient<T, Policy>(n, k, Policy()); }                            \
                                                                                                                                                        \
   template <class RT>                                                                                                                                  \
   ...
   inline boost::math::tools::promote_args_t<T> pow(T v) { return boost::math::pow<N>(v, Policy()); }                                                   \
                                                                                                                                                        \
   template <class T>                                                                                                                                   \
   T nextafter(const T &a, const T &b) { return static_cast<T>(boost::math::nextafter(a, b, Policy())); }                                               \
   template <class T>                                                                                                                                   \
   T float_next(const T &a) { return static_cast<T>(boost::math::float_next(a, Policy())); }                                                            \
   template <class T>                                                                                                                                   \
   T float_prior(const T &a) { return static_cast<T>(boost::math::float_prior(a, Policy())); }                                                          \
   template <class T>                                                                                                                                   \
   T float_distance(const T &a, const T &b) { return static_cast<T>(boost::math::float_distance(a, b, Policy())); }                                     \
   template <class T>                                                                                                                                   \
   T ulp(const T &a) { return static_cast<T>(boost::math::ulp(a, Policy())); }                                                                          \
                                                                                                                                                        \
   template <class RT1, class RT2>                                                                                                                      \
   ...
   {                                                                                                                                                    \
      return boost::math::tangent_t2n<T>(start_index, number_of_bernoullis_b2n, out_it, Policy());                                                      \
                                                                                                                                                        ...
                                                                                                                                                        \
   template <class T>                                                                                                                                   \
   inline boost::math::tools::promote_args_t<T> lambert_w0(T z) { return boost::math::lambert_w0(z, Policy()); }                                        \
   template <class T>                                                                                                                                   \
   inline boost::math::tools::promote_args_t<T> lambert_wm1(T z) { return boost::math::lambert_w0(z, Policy()); }                                       \
   template <class T>                                                                                                                                   \
   inline boost::math::tools::promote_args_t<T> lambert_w0_prime(T z) { return boost::math::lambert_w0(z, Policy()); }                                  \
   template <class T>                                                                                                                                   \
   inline boost::math::tools::promote_args_t<T> lambert_wm1_prime(T z) { return boost::math::lambert_w0(z, Policy()); }                                 \
                                                                                                                                                        \
   template <class T, class U>                                                                                                                          \
